...
@Service
public class SemanticWordExplorationService {
    ...
    public ResponseEntity<String> sendRequest(SemanticWordExplorationRequestDTO dto) {
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        headers.setBearerAuth(API_KEY);

        HttpEntity<SemanticWordExplorationRequestDTO> request = new HttpEntity<>(dto, headers);
