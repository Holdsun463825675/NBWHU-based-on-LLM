    ...
    <el-container class="main-container">
      <el-aside :width="isCollapse ? '80px' : '160px'" class="sidebar-container">
        ...
        >
          ...
          <el-menu-item index="/student/word">
            <el-icon><Search /></el-icon>
            <template #title>单词查询</template>
          </el-menu-item>
          <el-menu-item index="/student/dictionary">
            <el-icon><Collection /></el-icon>
            <template #title>词库</template>
          </el-menu-item>
          <el-menu-item index="/student/learn">
          ...
          <el-menu-item index="/student/read">
            <el-icon><Reading /></el-icon>
            <template #title>语境阅读</template>
          </el-menu-item>
          <el-menu-item index="/student/note">
            <el-icon><Star /></el-icon>
            <template #title>收藏</template>
          </el-menu-item>
          <el-menu-item index="/student/mean">
...
const username = computed(() => localStorage.getItem('username') || '学生')
