      ...
      <el-aside :width="isCollapse ? '80px' : '160px'" class="sidebar-container">
        ...
        >
          <el-menu-item index="/worker">
           ...
           <el-menu-item index="/worker/word">
            <el-icon><Search /></el-icon>
            <template #title>单词查询</template>
          </el-menu-item>
          <el-menu-item index="/worker/dictionary">
            <el-icon><Collection /></el-icon>
            <template #title>词库</template>
          </el-menu-item>
          <el-menu-item index="/worker/learn">
            <el-icon><Notebook /></el-icon>
            <template #title>每日学习</template>
          </el-menu-item>
          <el-menu-item index="/worker/chat">
            <el-icon><ChatLineRound /></el-icon>
            <template #title>情景对话</template>
          </el-menu-item>
          <el-menu-item index="/worker/test">
            <el-icon><EditPen /></el-icon>
            <template #title>测试</template>
          </el-menu-item>
          <el-menu-item index="/worker/read">
            <el-icon><Reading /></el-icon>
            <template #title>语境阅读</template>
          </el-menu-item>
          <el-menu-item index="/worker/note">
            <el-icon><Star /></el-icon>
            <template #title>收藏</template>
          </el-menu-item>
          <el-menu-item index="/worker/mean">
...
const username = computed(() => localStorage.getItem('username') || '职场人')
